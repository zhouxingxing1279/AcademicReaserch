...
研究主线先读 [13 集合值数据学习合同](docs/learning/13_set_valued_learning_contract.md)：核查带状态估计误差的残差学习与集员更新，建立安全中心条带基线，再研究保留联合状态—参数关系的固定复杂度方法。创新性须以近邻文献、一般性证明与同预算对照共同确认，不能仅凭学习、SMF、MPC和四旋翼的组合。另一候选是有限预算下学习选择认证收紧任务，是否采用RL取决于相对简单策略的真实收益。
