...
研究主线先读 [14 有限预算集员学习与控制价值](docs/learning/14_anytime_set_learning_and_control_value.md)：已给出完整覆盖下的中断安全更新证明、精确有理数对照，以及集合体积不等于控制收益的反例。两条候选贡献收敛为联合信息压缩的控制兼容性和同预算下控制相关计算分配；未宣称已有闭环递归可行性或学习优越性。
