...
def affine_learned_prediction(z,u,config,model,certificate):
...
class AffineLearnedZonotopeSMF(ZonotopeSMF):
    ...
    def advance(self,actual_u,observation):
        ...
        prediction,diag=affine_learned_prediction(self.zonotope,actual_u,self.config,self.model,self.certificate)
