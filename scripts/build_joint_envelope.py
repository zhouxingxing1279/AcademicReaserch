...
from smf_mpc.joint_envelope import joint_envelope as envelope
from smf_mpc.local_envelope import table_digest
...
def main():
    ...
    cert['table_sha256']=table_digest(lo,hi,bound)
    ...
    sources=[ROOT/'src/smf_mpc/joint_envelope.py',ROOT/'src/smf_mpc/local_envelope.py',ROOT/'src/smf_mpc/affine_model.py',ROOT/'src/smf_mpc/neural_model.py',ROOT/'src/smf_mpc/residual_envelope.py',Path(__file__)]
